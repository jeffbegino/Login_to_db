...
Public Class Insert_Product
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Try
            ...
            myquery = "INSERT INTO edp.product (Product_Id, ProductName, SupplierId, UnitPrice, Package, IsDiscontinued) values (@User_Id, @FirstName, @LastName, @City, @Country, @Phone)"
